...
//		By:			Xiao Ma
//		Note:		This file is originally named Krislet.java. 
//					I changed it to Replicant, since our intention
//					is to "clone" other agents. The name is from
//					Blade Runner, the SciFi movie.
//
package agent;
...
//
//***************************************************************************
class Replicant implements SendCommand
{
    //===========================================================================
    ...
    public Replicant(InetAddress host, int port, String team, String prototype) 
    ...
    private String		m_proto;		// prototype of the agent
